...
{
    [Serializable]
    [System.Obsolete("Duplicate copy kept for reference. Use the canonical AbilitySlot under Assets/Scripts/Abilities/Data instead.")]
    public class AbilitySlot
    {
        ...
        public void Use(global::AbilityContext context)
        {
            if (!CanUse()) return;
