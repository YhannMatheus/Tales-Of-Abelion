...
public class IAAnimatorController : MonoBehaviour
{
	...
	private void UpdateDeadState()
	{
		...
		if (IsDead)
		{
			...
			SetAnimatorBoolSafe(isFallingParam, false);
		}
	}
	...
	private void UpdateIAStateFlags()
	{
		...
		SetAnimatorBoolSafe(isFallingParam, IsFalling);
	}
	...
	{
		IsIdle = IsPatrol = IsChase = IsAttack = IsFlee = IsFalling = false;
